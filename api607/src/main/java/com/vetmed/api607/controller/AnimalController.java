...
public class AnimalController {
    ...
    @CrossOrigin
    @PostMapping("/animalAlert{animalId, alert}")
    public void updateAnimalAlert(@PathParam("animalId") int animalId, @PathParam("alert") String alert) {
        db.updateAlert(animalId, alert);
